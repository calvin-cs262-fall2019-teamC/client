 ...
 */
public class AnimalsTutorialPagerAdapter extends FragmentStatePagerAdapter {
     ...
     */
    public AnimalsTutorialPagerAdapter(FragmentManager fm, int numPages, Context app_context) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            case 0:
                ...
                fragment_data.putInt("activity_name_id", R.string.activity_five_title);
                tutorial1.setArguments(fragment_data);
                return tutorial1;
            case 1:
                fragment_data.putInt("textID", R.string.activity_five_info);
                break;
            case 2:
                return new TutorialToHistory();
            default:
                throw new RuntimeException("ERROR: unknown page visited in Animals tutorial.");
        }
